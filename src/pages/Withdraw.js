...
function Withdraw() {
  ...
  const formikProps = {
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      resetForm();
      alert('Money Withdrawed. Please go to home page to see the avilable balance!');
    }
  };
      ...
      >
        ...
        <Form>
          <div className='form-group'>
            ...
            <Field type='number' className='form-control' id='amount' name='amount'  placeholder='please enter your amount' />
